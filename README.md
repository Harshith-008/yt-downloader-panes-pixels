...
- **YouTube Downloader Suite (Tabbed UI):** Toggle seamlessly between:
  - **Channel Shorts:** Input a channel handle, retrieve and sort the top 100 Shorts by view count, and batch-download them.
  - **Hashtag Shorts:** Aggregate and download trending Shorts from multiple hashtags concurrently, with deduplication.
  - **Video Downloader:** Download any standard high-quality YouTube video via direct URL.
- **Advanced Sorting System:** Sort hashtag Shorts by Views (High-to-Low / Low-to-High), Title (A-Z), or Duration.
...
1. Download the latest installer `YT_Downloader_Setup.exe` from the [Releases](https://github.com/Harshith-008/yt-downloader-panes-pixels/releases) page.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Harshith-008/yt-downloader-panes-pixels.git
   cd yt-downloader-panes-pixels
   ```
